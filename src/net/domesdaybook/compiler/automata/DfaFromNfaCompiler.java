 ...
 * @author matt
 */
public final class DfaFromNfaCompiler implements Compiler<State, State> {

    private static DfaFromNfaCompiler defaultCompiler;
    public static State dfaFromNfa(State nfaInitialState) throws CompileException {
        defaultCompiler = new DfaFromNfaCompiler();
    ...
    public DfaFromNfaCompiler() {
        this(null, null, null);
    }

    public DfaFromNfaCompiler(final StateFactory stateFactory) {
        this(null, stateFactory, null);
    }

    public DfaFromNfaCompiler(final TransitionFactory transitionFactory) {
        this(null, null, transitionFactory);
    }
    
    public DfaFromNfaCompiler(final Compiler<State, String> nfaCompilerToUse) {
        this(nfaCompilerToUse, null, null);
    }
    
    public DfaFromNfaCompiler(final Compiler<State, String> nfaCompilerToUse, final StateFactory stateFactory) { 
        this(nfaCompilerToUse, stateFactory, null);
    }
    
    public DfaFromNfaCompiler(final Compiler<State, String> nfaCompilerToUse, final TransitionFactory transitionFactory) {
        this(nfaCompilerToUse, null, transitionFactory);
    }

    public DfaFromNfaCompiler(Compiler<State, String> nfaCompilerToUse, StateFactory StateFactoryToUse, TransitionFactory factoryToUse) {
