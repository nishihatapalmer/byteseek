...
public class ByteStringMatcherTest {
    ...
    public void testNullParse() {
        ByteSequenceMatcher.fromExpression(null);
    }

    @Test(expected=IllegalArgumentException.class)
    public void testEmptyParse() {
        ByteSequenceMatcher.fromExpression("");
    }

    @Test(expected=IllegalArgumentException.class)
    public void testNonHexParse() {
        ByteSequenceMatcher.fromExpression("This should fail");
    }

    @Test(expected=IllegalArgumentException.class)
    public void testSomeHexParse() {
         ByteSequenceMatcher.fromExpression("010203FFEED1This should fail.");
    }

    @Test(expected=IllegalArgumentException.class)
    public void testMissingHexCharParse() {
        ByteSequenceMatcher.fromExpression("A1B2C");
    }
    ...
    public void testCorrectHexCharParse() {
        ...
        ByteSequenceMatcher.fromExpression("Fd"); // test a single byte with mixed hex case.
        ByteSequenceMatcher.fromExpression("000102A1b3Cde4Fe"); // test a long sequence with mixed hex case.
    }
    ...
    public void testLength() {
        ...
        instance = ByteSequenceMatcher.fromExpression("01");
        assertEquals("Test length one byte.", 1, instance.length());

        instance = ByteSequenceMatcher.fromExpression("01FF");
        assertEquals("Test length two bytes.", 2, instance.length());

        instance = ByteSequenceMatcher.fromExpression("01FF3d4f728912");
        assertEquals("Test length seven bytes.", 7, instance.length());

        instance = ByteSequenceMatcher.fromExpression("01FF3d01FF3d4f7289124f72891201FF3d4f728912");
    ...
    public void testMatchesBytes() {
        ...
        instance = ByteSequenceMatcher.fromExpression(fileStartHexBytes);
        matchFrom = 0L;
    ...
    public void testErrorOnMatchesBytesOutsideFile() {
        final ByteSequenceMatcher instance = ByteSequenceMatcher.fromExpression("010203");
